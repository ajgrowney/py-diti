...
class resultsObj:
    ...
    def compileHistogramResults(self,single_im_f, single_im_fc):
        ...
        self.means["right_f"]["b"].append(single_im_f['right_mean'][0])
        self.means["right_f"]["g"].append(single_im_f['right_mean'][1])
        self.means["right_f"]["r"].append(single_im_f['right_mean'][2])
        self.means["right_fc"]["b"].append(single_im_fc['right_mean'][0])
        self.means["right_fc"]["g"].append(single_im_fc['right_mean'][1])
        self.means["right_fc"]["r"].append(single_im_fc['right_mean'][2])
        self.means["left_f"]["b"].append(single_im_f['left_mean'][0])
        self.means["left_f"]["g"].append(single_im_f['left_mean'][1])
        self.means["left_f"]["r"].append(single_im_f['left_mean'][2])
        self.means["left_fc"]["b"].append(single_im_fc['left_mean'][0])
        self.means["left_fc"]["g"].append(single_im_fc['left_mean'][1])
        self.means["left_fc"]["r"].append(single_im_fc['left_mean'][2])
            ...
            writer.writerow(
                {
                    ...
                    'mean_right_f_r': cancer_obj.means["right_f"]["r"][i],
                    'mean_right_fc_r': cancer_obj.means["right_fc"]["r"][i],
                    'mean_right_f_g': cancer_obj.means["right_f"]["g"][i],
                    'mean_right_fc_g': cancer_obj.means["right_fc"]["g"][i],
                    'mean_right_f_b': cancer_obj.means["right_f"]["b"][i],
                    'mean_right_fc_b': cancer_obj.means["right_fc"]["b"][i],
                    'mean_left_f_r': cancer_obj.means["left_f"]["r"][i],
                    'mean_left_fc_r': cancer_obj.means["left_fc"]["r"][i],
                    'mean_left_f_g': cancer_obj.means["left_f"]["g"][i],
                    'mean_left_fc_g': cancer_obj.means["left_fc"]["g"][i],
                    'mean_left_f_b': cancer_obj.means["left_f"]["b"][i],
                    'mean_left_fc_b': cancer_obj.means["left_fc"]["b"][i],
                    'cancer': 'Y'
                }
            )
            ...
            writer.writerow(
                {
                    ...
                    'mean_right_f_r': nocancer_obj.means["right_f"]["r"][j],
                    'mean_right_fc_r': nocancer_obj.means["right_fc"]["r"][j],
                    'mean_right_f_g': nocancer_obj.means["right_f"]["g"][j],
                    'mean_right_fc_g': nocancer_obj.means["right_fc"]["g"][j],
                    'mean_right_f_b': nocancer_obj.means["right_f"]["b"][j],
                    'mean_right_fc_b': nocancer_obj.means["right_fc"]["b"][j],
                    'mean_left_f_r': nocancer_obj.means["left_f"]["r"][j],
                    'mean_left_fc_r': nocancer_obj.means["left_fc"]["r"][j],
                    'mean_left_f_g': nocancer_obj.means["left_f"]["g"][j],
                    'mean_left_fc_g': nocancer_obj.means["left_fc"]["g"][j],
                    'mean_left_f_b': nocancer_obj.means["left_f"]["b"][j],
                    'mean_left_fc_b': nocancer_obj.means["left_fc"]["b"][j],
                    'cancer': 'N'
                }
            )
